...
namespace EDziennik.Views
{
    public class MarksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,value,description")] Mark mark)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,value,description")] Mark mark)
        {
            if (id != mark.Id)
            {
                return NotFound();
